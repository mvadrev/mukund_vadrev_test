...
// Nodes list
nodes_list = ["3000/hello", "3001/hello", "3003/hello"];
...
app.post("/request", function(req, res) {
  ...
  for (let i = 0; i < nodes_list.length; i++) {
    axios
      ...
      .then(response => {
        console.log("Sending data to node", nodes_list[i[0]]);
...
app.listen(
  ...
  console.log(
    "Server" +
      node_id +
      " listening on 3001" +
      "|Simply send an API request to start using this Geo distributed, fault tolernt LRU Service| "
  )
);
